      ...
      <div className="pdp-wrap pdp-hero">
        ...
        <div className="pdp-right">
          ...
          <div className="pdp-size-block">
            ...
            {lowStock && (
              <div className="mt-3 flex items-center gap-2 text-xs font-mono font-semibold text-amber-400 bg-amber-500/10 px-3 py-1.5 rounded-xl border border-amber-500/20">
