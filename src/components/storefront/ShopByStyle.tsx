      ...
      <div className="wrap">
        ...
        <div className="mt-12 text-center pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="font-mono text-xs text-neutral-300">
            Looking for something unique? Design your bespoke 240GSM t-shirt in our 3D Print Lab for <strong className="text-[var(--accent)]">₹600</strong> (all prints & free shipping included).
          </span>
          <Link
            href="/custom-print"
          ...
          >
            <span>Enter 3D Custom Lab • ₹600</span>
